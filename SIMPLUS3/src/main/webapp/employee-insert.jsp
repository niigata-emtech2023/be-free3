...
<%@ include file="header.jsp" %>
  ...
  <tr><th>氏<span class="req_span">必須</span><p class="note">全角漢</p></th><td class="normal_td"><input type="text" size="10"  name="sur_name"  required placeholder="苗字を入力してください" class="form_text"></td></tr>
  <tr><th>名<span class="req_span">必須</span><p class="note">全角漢</p></th><td class="normal_td"><input type="text" size="10" name="first_name"  required   placeholder="名前を入力してください" class="form_text"></td></tr>
  <tr><th>氏（かな）<span class="req_span">必須</span><p class="note">全角かな</p></th><td class="normal_td"><input type="text" size="20" name="sur_kana_name" placeholder="ひらがなで入力してください"  required class="form_text"></td></tr>
  <tr><th>名（かな）<span class="req_span">必須</span><p class="note">全角かな</p></th><td class="normal_td"><input type="text" size="20" name="first_kana_name"  placeholder="ひらがなで入力してください" required class="form_text"></td></tr>
